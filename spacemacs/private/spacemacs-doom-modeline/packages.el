;;; packages.el --- doom-theme layer packages file for Spacemacs.
;;
...
;; added to `doom-theme-packages'. Then, for each package PACKAGE:
;;
...
(defconst spacemacs-doom-modeline-packages
  '(
    anaphora
    anzu
    eldoc-eval
...
(defun spacemacs-doom-modeline/init-anaphora ()
  (use-package anaphora))

(defun spacemacs-doom-modeline/init-anzu ()
  (use-package anzu
    :demand t))

(defun spacemacs-doom-modeline/init-eldoc-eval ()
  (use-package eldoc-eval
    :config
    (setq eldoc-in-minibuffer-show-fn 'doom-eldoc-show-in-mode-line)
    (eldoc-in-minibuffer-mode +1)))

(defun spacemacs-doom-modeline/init-evil-anzu ()
  (use-package evil-anzu
    :demand t))

(defun spacemacs-doom-modeline/init-evil-multiedit ()
